...
| | |
|---|---|
| Registros analizados | 983,343 (617,216 de México; se excluyeron 16,742 fósiles) |
| Especies nativas en México | **657** (607 terrestres, 50 marinas), en 11 órdenes terrestres |
| Especies endémicas | **201** |
| En la NOM-059 / amenazadas según la IUCN | **193** / **90** |
| Especies sin registros desde 2000 | **91** (26 en la NOM-059) |
| Sitios con vegetación natural en 1985 que hoy tienen uso antrópico | **25.5%** |

- **La colecta científica se desplomó.** Pasó de 23,300 registros en la década de 1960 a 1,000 en 2020–2025. Desde 2010, casi el 88% de los registros son observaciones ciudadanas, lo que deja con cada vez menos datos a roedores, musarañas y murciélagos.
- **Con el esfuerzo estandarizado, la riqueza es similar en el centro y el sur.** Las zonas 14b, 14a, 13 y 15 tienen entre 285 y 305 especies con 11,657 registros cada una. Las zonas difieren sobre todo en *qué* especies tienen: entre 11 y 16 comparten solo 14 especies (Jaccard = 0.05), y la diferencia se debe casi por completo a recambio.
- **Hay un reemplazo latitudinal de roedores por murciélagos.** Los murciélagos son el 51% de las especies en el extremo sur y el 18% en el norte; los roedores siguen el patrón inverso. Las curvas se cruzan entre los 19 y 22° N.
- **La alta montaña concentra endemismo y riesgo.** De las 30 especies con mayor altitud, 25 son endémicas y 14 están en riesgo, entre ellas el teporingo (*Romerolagus diazi*) y *Habromys lepturus*.
- **Las sierras de Oaxaca y Guerrero son el principal vacío de protección.** Treinta y dos especies en riesgo tienen 10% o menos de sus registros en ANP. Doce no tienen ninguno, entre ellas *Lepus flavigularis*, *Megadontomys cryophilus* y *Habromys ixtlani*.
- **La NOM-059 y la IUCN coinciden solo en parte.** Veintinueve especies amenazadas globalmente no están en la norma, como *Dasyprocta mexicana* (CR) y *Tayassu pecari* (VU).
...
Los datos del SNIB no se incluyen en el repositorio. Descarga la capa de mamíferos del [geoportal de la CONABIO](http://www.conabio.gob.mx/informacion/gis/?mylayers=mamiferos%7Ct&active=mamiferos) (versión 2025-12), guarda `mamiferos.csv` en `data/crudo/snib_2025-12/` y conviértelo a Parquet:
